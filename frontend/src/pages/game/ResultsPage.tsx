...
export default function ResultsPage() {
  ...
  if (isLoading) {
    return (
      <div className="route-light min-h-screen bg-gradient-to-br from-[#fffdf8] via-[#f6faf9] to-[#eaf4f7] flex items-center justify-center">
  ...
  if (error || !data) {
    return (
      <div className="route-light min-h-screen bg-gradient-to-br from-[#fffdf8] via-[#f6faf9] to-[#eaf4f7] flex items-center justify-center p-4">
  ...
  return (
    <div ref={containerRef} className="route-light min-h-screen relative overflow-hidden border-t-2 border-[#e5a92f]/70 bg-gradient-to-br from-[#fffdf8] via-[#f6faf9] to-[#eaf4f7]">
      {/* Background */}
