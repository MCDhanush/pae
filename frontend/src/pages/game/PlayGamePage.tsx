...
export default function PlayGamePage() {
  ...
  return (
    <div className="route-light min-h-screen relative overflow-hidden border-t-2 border-[#e5a92f]/70 bg-gradient-to-br from-[#fffdf8] via-[#f6faf9] to-[#eaf4f7] flex flex-col">
      {/* Animated bg blobs */}
